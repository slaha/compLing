...
public class RuleHolderImpl implements RuleHolder {
	...
	private final List<WordModificationRule> wordModificationRules;
	...
	public RuleHolderImpl() {
		...
		wordModificationRules = new ArrayList<WordModificationRule>();
	...
	private void add(WordModificationRule rule) {
		wordModificationRules.add(rule);
	}
	...
	public void add(Rule rule) {
		...
		} else if (rule instanceof WordModificationRule) {
			add((WordModificationRule)rule);
		}
	}
